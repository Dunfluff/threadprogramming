...
public class GUIAssignment1 implements ActionListener
{
	...
	private JLabel movText;		// Text that moves
	...
	private void InitializeGUI()
	{
		...
		movText = new JLabel("Text");
		movText.setBounds(10,  19,  50,  50);
		pnlDisplay.add(movText);
		...
		Border b3 = BorderFactory.createTitledBorder("Date Thread");
		...
		clock = new JLabel();
		clock.setBounds(10, 69, 200, 50);
		pnlTriangle.add(clock);
	...
	/* 
	 * Starts and stops threads in controller whilst providing needed JLables.
	 */
	@Override
